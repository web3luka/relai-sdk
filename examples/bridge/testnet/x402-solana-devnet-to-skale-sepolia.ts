/**
 * TESTNET E2E — x402 auto-bridge: Solana Devnet → SKALE Base Sepolia
 *
 * Chains:
 *   Source: Solana Devnet — USDC 4zMMC9srt5Ri5X14GAgXhaHii3GnPAEERYPJgZJDncDU
 *   Target: SKALE Base Sepolia (eip155:324705682)
 *
 * This is a SUPPORTED testnet bridge direction in 402-everywhere.
 * Uses x402 auto-bridge with Solana devnet RPC.
 *
 * Expected: will fail with insufficient funds if no USDC-Dev on Solana Devnet,
 * or succeed if funded.
 *
 * Prerequisites:
 ...
 * Run client:   SOLANA_PRIVATE_KEY=... npx tsx examples/bridge/testnet/x402-solana-devnet-to-skale-sepolia.ts
 */
...
console.log("=== Solana Devnet -> SKALE Base Sepolia (testnet) ===");
try {
